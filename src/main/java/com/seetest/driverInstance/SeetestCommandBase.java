...
public class SeetestCommandBase extends SeetestDriverInstance {
     ...
     */
    public boolean verifyElementPresent(By byLocator, String elementName) {
        ...
        try {
            ...
            extent.extentLogger("checkElementPresent", "The element " + elementName + " is displayed");
            return true;
        } catch (Exception e) {
            softAssert.assertEquals(false, true, "Element" + elementName + " " + " is not visible");
            softAssert.assertAll();
            logger.error("Element" + elementName + " " + "is not visible");
            extent.extentLogger("checkElementPresent", "The element " + elementName + " is not displayed");
            return false;
        }
    }
     ...
     * @param byLocator the by locator
     */
    public void click(By byLocator, String elementName) {
     ...
     * @param text      the text
     */
    public void type(By byLocator, String text, String strField) {

        try {
            WebElement element = findElement(byLocator);
            element.sendKeys(text);
            logger.info("Typed the value " + text + " in to object " + byLocator);
            extent.extentLogger("Type", "Able to send the text: " + text
                    + " for the element " + strField);
            /*extent.extentLogger("type", "Typed the Web Element" +" "+ element.toString());
            extent.extentLogger("Enter '"+strField+"'", "Entered '"+text+"' in '"+strField+"'");*/
        } catch (Exception e) {
            logger.error(e);
